...
HD_PWD='C:/Users/niran/Documents/Main/Verilog Experiments/magnitude_comparator/magnitude_comparator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mag_comp_2bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mag_comp_2bit.tcl
